...
# Read input with backspace support
input_loop:
    li t0, KEYBOARD_CTRL
    lw t1, 0(t0)
    andi t1, t1, 0x1
...
# ============================================
# TOKENIZER - Extract tokens with tab support
# ============================================
get_next_token:
    la t0, token
    mv t1, s1
...
# ============================================
# CHECK REGISTER - Supports ABI names and x0-x31
# ============================================
check_is_register:
    mv t0, a0
    lb t1, 0(t0)
...
# ============================================
# PARSE IMMEDIATE - Convert string to integer
# Output: a0 = value, a1 = 1 if success, 0 if fail
# ============================================
parse_immediate:
    mv t0, a0
    lb t1, 0(t0)
...
# ============================================
# CHECK IMMEDIATE WITH RANGE VALIDATION
# ============================================
check_is_5bit_imm:
    addi sp, sp, -4
    sw ra, 0(sp)
...
# ============================================
# CHECK LABEL - Must not be an opcode
# ============================================
check_is_label:
    mv t0, a0
    lb t1, 0(t0)
...
# ============================================
# CHECK ADDRESS FORMAT: offset(register)
# ============================================
check_is_address:
    addi sp, sp, -8
    sw ra, 0(sp)
